...
.. code:: bash
   ...
   $ find /projects/python/aea-release -name "libasp.so"
   /projects/python/aea-release/lib64/libasp.so
   $ export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/projects/python/aea-release/lib64
   $ abaqus -job <my_input_file> -user /projects/python/aea-release/lib64/asp_umat.o
