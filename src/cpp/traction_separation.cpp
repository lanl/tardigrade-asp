...
namespace tractionSeparation{
    ...
    errorOut computeParticleOverlap( const floatVector &Xi_1, const floatVector &dX, const floatType &R_nl,
         ...
         * \param &d2OverlapdGradChidGradChi: The second gradient of the overlap w.r.t. the spatial gradient of the micro-deformation tensor
         * 
         * \param &d3OverlapdXi_1dXi_1dXi_1: The second gradient of the overlap w.r.t. the local reference relative micro-position vector
         */
                    ...
                    for ( unsigned int K = 0; K < F.size( ); K++ ){
                        ...
                        for ( unsigned int A = 0; A < xi_t.size( ); A++ ){
                            ...
                            for ( unsigned int B = 0; B < xi_t.size( ); B++ ){
                                ...
                                d2OverlapdFdChi[ I ][ F.size( ) * J + K ] += d2Overlapdxi_tdxi_t[ I ][ xi_t.size( ) * A + B ] * dxi_tdF[ A ][ J ] * dxi_tdchi[ B ][ K ];
                            ...
                            for ( unsigned int B = 0; B < chi_nl.size( ); B++ ){
                                ...
                                d2OverlapdFdChi[ I ][ F.size( ) * J + K ] += d2Overlapdchi_nldxi_t[ I ][ xi_t.size( ) * B + A ] * dxi_tdF[ A ][ J ] * dchi_nldchi[ B ][ K ];
                    ...
                    for ( unsigned int K = 0; K < gradChi.size( ); K++ ){
                        ...
                        for ( unsigned int A = 0; A < xi_t.size( ); A++ ){
                            ...
                            for ( unsigned int B = 0; B < chi_nl.size( ); B++ ){
                                ...
                                d2OverlapdFdGradChi[ I ][ gradChi.size( ) * J + K ] += d2Overlapdchi_nldxi_t[ I ][ xi_t.size( ) * B + A ] * dxi_tdF[ A ][ J ] * dchi_nldGradChi[ B ][ K ];

                                d2OverlapdChidGradChi[ I ][ gradChi.size( ) * J + K ] += d2Overlapdchi_nldxi_t[ I ][ xi_t.size( ) * B + A ] * dxi_tdchi[ A ][ J ] * dchi_nldGradChi[ B ][ K ];
                        ...
                        for ( unsigned int A = 0; A < chi_nl.size( ); A++ ){
                            ...
                            for ( unsigned int B = 0; B < chi_nl.size( ); B++ ){
                                ...
                                d2OverlapdChidGradChi[ I ][ gradChi.size( ) * J + K ] += d2Overlapdchi_nldchi_nl[ I ][ chi_nl.size( ) * A + B ] * dchi_nldchi[ A ][ J ] * dchi_nldGradChi[ B ][ K ];
                    ...
                    for ( unsigned int K = 0; K < gradChi.size( ); K++ ){
                        ...
                        for ( unsigned int A = 0; A < chi_nl.size( ); A++ ){
                            ...
                            for ( unsigned int B = 0; B < chi_nl.size( ); B++ ){
                                ...
                                d2OverlapdGradChidGradChi[ I ][ gradChi.size( ) * J + K ] += d2Overlapdchi_nldchi_nl[ I ][ chi_nl.size( ) * A + B ] * dchi_nldGradChi[ A ][ J ] * dchi_nldGradChi[ B ][ K ];
